...
# --- env wiring for the two indexes ---
...
if not all([PAPERS_ENDPOINT_NAME, PAPERS_DEPLOYED_INDEX_ID,
            KB_ENDPOINT_NAME, KB_DEPLOYED_INDEX_ID]):
    # fail fast in Cloud Run if misconfigured
